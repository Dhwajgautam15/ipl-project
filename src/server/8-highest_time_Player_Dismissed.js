function highestNoPlayerDismissed(deliveries){
    ...
    deliveries.forEach(delivery => {
        if(delivery.player_dismissed!=null && delivery.dismissal_kind != "run out"){
            if(batsmanDismisal[delivery.bowler] && batsmanDismisal[delivery.bowler][delivery.batsman]){
                batsmanDismisal[delivery.bowler][delivery.batsman]++;
            }
            else if(batsmanDismisal[delivery.bowler]&&!batsmanDismisal[delivery.bowler][delivery.batsman]){
